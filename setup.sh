...
cp /home/panini/panini-cluster/run.sh /usr/local/bin/
rm /home/panini/panini-cluster/run.sh
chmod a+x /usr/local/bin/run.sh
cp /home/panini/panini-cluster/panini.service /etc/systemd/system/
systemctl daemon-reload
systemctl enable panini.service
systemctl start panini.service
